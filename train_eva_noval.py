...
# Training Class without validation
class TrainerNoVal:
    def __init__(
        self, 
        model: nn.Module, 
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.epochs):
            ...
            print(f"Epoch {epoch+1}, Train Loss: {train_loss:.4f} | Time: {epoch_duration:.2f}s")
...
if __name__ == "__main__":
    ...
    # Define dataset using the entire dataset.
    ...
    # Define DataLoader using the entire dataset.
    train_loader = DataLoader(
        train_dataset, 
